...
// function scrollsmooth() digunakan untuk mengaktifkan pengguliran halus untuk seluruh halaman
  function scrollSmooth() {
    var target = document.getElementById("home-list");
    // method scrollintoview() adalah menggulir elemen ke area yang terlihat di jendela browser.
      ...
      <div style={{ backgroundColor: "#E5E5E5" }} className="pb-10 pt-60">
        ...
        <div className="w-full p-4 md:w-[1216px] mx-auto" id="home-list">
          <div className="flex gap-4 flex-wrap">
            ...
            {/* Method Slice() adalah method mengembalikan elemen yang dipilih dalam array, sebagai array baru. */}
            ...
            {/* Operator && => expression sebelah kiri setelah dievaluasi menghasilkan nilai false, 
            maka operator AND akan mengembalikan expression pertama.  
            Kebalikannya, jika expression sebelah kiri setelah dievaluasi menghasilkan nilai true, 
            maka operator AND akan mengembalikan expression kedua */}
            {visible < data.length && (
